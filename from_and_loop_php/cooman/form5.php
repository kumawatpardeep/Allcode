...
<body>
<div class="ramesh" ></div>
<form action="register_action.php" method="post" id="monu">
  <div class="container">
    <h1>Register</h1>
    ...
    <button type="button" class="registerbtn" onclick="return check()">Register</button>
  </div>
